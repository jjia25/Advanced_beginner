...
const ImageTransformations = ({width, rgb, selectedShirt, text}) => {
    return (
        <Image publicId={selectedShirt.main+'.jpg'}>
            ...
            <Transformation effect={'red:'+((-1+rgb.r/255)*100).
            toFixed(0)} />
            <Transformation effect={'blue:'+((-1+rgb.b/255)*100).
            toFixed(0)} />
            <Transformation effect={'green:'+((-1+rgb.g/255)*100).
            toFixed(0)} />
            <Transformation underlay={selectedShirt.underlay}
            flags="relative" width="1.0" />
            <Transformation overlay={selectedShirt.overlay}
            flags="relative" width="1.0"  />
            <Transformation overlay={'text:Roboto_30:'+text}
            flags="relative" gravity="center" />
        </Image>
    );
};
                 ...
                 <div id="demoContainer">
                      <div id="header">
                          <a href="http://cloudinary.com/">
                              <img width="172" height="38"
                              src="http://res-1.cloudinary.com/cloudinary/image/asset/dpr_2.0/logo-e0df892053afd966cc0bfe047ba93ca4.png" alt="Cloudinary Logo" />
                          </a>
                      ...
                      <div id="imageThumbs">
                          <ul id="thumbs">
                              {this.state.shirts.map(thumb => {
                                 return (
                                 <li className={thumb.main
                                   === this.state.selectedShirt.main ?
                                   'active': ''}
                  ...
                  <div id="demoInputContainer">
                      ...
                      <div className="inputSelections">
                          ...
                          placeholder="Enter text" value={this.state.text}
